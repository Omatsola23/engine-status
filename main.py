...
import numpy as np
#creating title and header for the streamlit app
...
#loading the model from collab
model=py.load("lg.pkl")
#creating user's input, ENTER button and prediction display for the streamlit app
